...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
    ...
    @if (session('success'))
        {{-- Notifikasi sukses ini mengarahkan user untuk membaca hasil aksi terakhir sebelum hilang otomatis --}}
        <div id="notification"
        ...
        <script>
            // Auto-hide setelah 3 detik supaya fokus user kembali ke halaman tujuan.
            setTimeout(() => {
