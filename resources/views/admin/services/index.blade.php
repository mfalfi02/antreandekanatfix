...
<div class="max-w-6xl mx-auto py-10 px-6">
    @php
        ...
        $canCreate = in_array($currentRole, ['admin', 'pejabat'], true);
        $canCreateDelete = $currentRole === 'admin';
        $canEdit = in_array($currentRole, ['admin', 'pejabat'], true);
        $backRoute = $currentRole === 'pejabat' ? route('dsn') : route('adm');
    @endphp
    ...
    <div class="overflow-x-auto bg-white rounded-xl border border-blue-100 shadow-md p-4">
        <table class="w-full table-auto border-collapse">
            ...
            <tbody class="divide-y">
                ...
                @empty
                    <tr>
                        <td colspan="{{ $canEdit ? 5 : 4 }}" class="px-4 py-6 text-center text-gray-500">
