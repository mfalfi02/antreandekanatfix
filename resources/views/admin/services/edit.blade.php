    ...
    <div class="bg-white shadow-md rounded-xl overflow-hidden">
        ...
        <div class="p-6">
            ...
            <form action="{{ route('services.update', $service->id) }}" method="POST" class="space-y-6">
                ...
                <!-- Nama Service -->
                <div>
                    <label class="block font-medium text-gray-700">Nama Service <span class="text-red-500">*</span></label>
                ...
                <!-- Estimasi Waktu -->
                <div>
                    <label class="block font-medium text-gray-700">Estimasi Waktu <span class="text-red-500">*</span></label>
                    <input type="text" name="est_time"
                        ...
                        value="{{ old('est_time', $service->est_time) }}"
